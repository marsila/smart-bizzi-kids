    ...
    return(
        <div className="relative font-sans min-h-screen bg-sky-200 select-none overflow-hidden">
            <header className="fixed left-4 right-4 top-4 flex justify-between items-center z-50 pointer-events-none">
                <Link 
                    href="kids/map"
                    className="bg-amber-300 border-b-4 border-amber-600 text-slate-900 rounded-2xl pointer-events-auto shadow-lg active:border-b-0 active:mt-1 transition-all flex justify-center items-center"
                    aria-label="Home"
                >
                    <Home className="w-12 h-12 stroke-3"/>
                </Link>
                <button
